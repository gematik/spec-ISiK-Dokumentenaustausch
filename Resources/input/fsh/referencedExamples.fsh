...
* identifier[=].system = "https://fhir.de/sid/gkv/kvid-10"
...
* name[=].family = "Fürstin von Musterfrau"
  * extension[0].url = "https://fhir.de/StructureDefinition/humanname-namenszusatz"
  * extension[=].valueString = "Graf"
  * extension[+].url = "https://hl7.org/fhir/R4/StructureDefinition/humanname-own-name"
  * extension[=].valueString = "Musterfrau"
  * extension[+].url = "https://hl7.org/fhir/R4/StructureDefinition/humanname-own-prefix"
  * extension[=].valueString = "von"
* name[=].given = "Erika"
* name[=].prefix = "Dr."
  * extension.url = "https://hl7.org/fhir/R4/StructureDefinition/iso21090-EN-qualifier"
...
* address[=].line[0].extension[0].url = "https://hl7.org/fhir/R4/StructureDefinition/iso21090-ADXP-streetName"
* address[=].line[=].extension[=].valueString = "Musterweg"
* address[=].line[=].extension[+].url = "https://hl7.org/fhir/R4/StructureDefinition/iso21090-ADXP-houseNumber"
* address[=].line[=].extension[=].valueString = "2"
* address[=].line[+].extension.url = "https://hl7.org/fhir/R4/StructureDefinition/iso21090-ADXP-additionalLocator"
...
* address[=].line = "Postfach 8 15"
  * extension.url = "https://hl7.org/fhir/R4/StructureDefinition/iso21090-ADXP-postBox"
...
Usage: #example
* extension.url = "https://fhir.de/StructureDefinition/Aufnahmegrund"
...
* hospitalization.dischargeDisposition.extension.url = "https://fhir.de/StructureDefinition/Entlassungsgrund"
